...
test_Lot1 <- t.test(subset(suspensionData,Manufacturing_Lot =="Lot1")$PSI, mu =1500)

test_Lot1

test_Lot2 <- t.test(subset(suspensionData,Manufacturing_Lot == "Lot2")$PSI, mu= 1500)

test_Lot2

test_Lot3 <- t.test(subset(suspensionData,Manufacturing_Lot == "Lot3")$PSI, mu= 1500)
